...
<div class="col-md-6 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Mise a jour <a href="{{route("category.show", $category->id)}}" class="text-decoration-none"><span class="text-primary">{{$category->name}}</span></a> Category</h4>
