...
<div class="col-md-6 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title">Update <a href="{{route("chef.show", $chef->id)}}" class="text-decoration-none"><span class="text-primary">{{$chef->name}}</span></a> information</h4>
            <form class="forms-sample" method="POST" action="{{route("chef.update")}}" enctype="multipart/form-data">
