...
@section('page-title') Dishes @endsection
...
<div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <h4 class="card-title">Nos delicieux plats</h4>
            ...
            <tbody>
                @foreach ($dishes as $dish)
                    <tr>
                        ...
                        <td class="d-none d-xl-table-cell"><a href="{{route("category.show", $dish->category->id)}}" class="text-decoration-none">{{$dish->category->name}}</a></td>
                        <td>
